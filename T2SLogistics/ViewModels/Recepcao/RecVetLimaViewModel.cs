...
{
    public class RecVetLimaViewModel : RecepcaoMercadoria, INotifyPropertyChanged, IRecepcaoMercadoria<RecVetLimaViewModel>
    {

        public event PropertyChangedEventHandler PropertyChanged;
        RecVetLimaViewModel recVM;

        public RecVetLimaViewModel()
        {
        ...
        public RecVetLimaViewModel GenerateNewRec(OrderViewModel orderVM)
        {

            recVM = new RecVetLimaViewModel();
            recVM.Order = orderVM;
        ...
        public RecVetLimaViewModel Add(RecVetLimaViewModel entity)
        {
